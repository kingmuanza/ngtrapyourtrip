CinetPay = new class {
    ...
    async setConfig(e = this.config) {
        if ("object" != typeof e || void 0 === e) return this.error.message = "OBJECT_REQUIRED", void(this.error.description = "Set an object in your setConfig method");
        this.config = e, this.config.mode = e.mode ? e.mode : this.config.mode, this.type = this.config.type && "MOBILE" === this.config.type.toUpperCase() ? "MOBILE" : this.type, delete this.config.mode, delete this.config.type
    }
    createHtmlModalElement() {
        let e = document.getElementById("cp_modal_first_parent"),
            t = document.createElement("div");
        t.className = "cp-content-wrapper", t.id = "modal_first_parent_content_wrapper";
        let p = document.createElement("div");
        p.className = "cp-content", p.id = "cp-content", e.appendChild(t), t.appendChild(p)
    }
    closeCheckout() {
        document.getElementById("cp-close").addEventListener("click", (() => {
            document.getElementById("cp_modal_first_parent").remove(), this.checkout_close = !0
        }))
    }
    insertSvgCloseBtn(e) {
        navigator.userAgent.match(/iPhone/i) && "WEB" === this.type ? (e.innerHTML = "x", e.style.color = "red", e.style.fontSize = "inherit", e.style.fontWeight = "500") : e.innerHTML = '<svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"\n\t viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">\n<g>\n\t<g>\n\t\t<polygon points="512,59.076 452.922,0 256,196.922 59.076,0 0,59.076 196.922,256 0,452.922 59.076,512 256,315.076 452.922,512\n\t\t\t512,452.922 315.076,256 \t\t"/>\n\t</g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n<g>\n</g>\n</svg>'
    }
    displayButton() {
        if ("WEB" === this.type && null == document.getElementById("cp-close")) {
            ...
            t.className = "cp-close", t.id = "cp-close", e.appendChild(t), this.insertSvgCloseBtn(t), this.closeCheckout()
        }
    }
    async getCheckout(e) {
        if ("object" != typeof e || void 0 === e) return this.error.message = "OBJECT_REQUIRED", void(this.error.description = "Set an object in your getCheckout method"); {
            this.payment_data = e;
            let t = document.getElementsByTagName("head")[0],
                p = document.getElementsByTagName("body")[0],
                i = document.createElement("div");
            i.className = "cp-modal", i.id = "cp_modal_first_parent", i.setAttribute("data-tiorna", "trigger-modal");
    ...
    async initSocket() {
        ...
        e.on("connect", (() => {
            if (this.config.device_id = e.id, this.socket_disconnect) {
                if (console.log("Reconnected"), this.old_socket_id = this.new_socket_id, null == this.response) {
                    let t = this.http();
                    t.onprogress = function(e) {}, t.onreadystatechange = function(e) {
                        let p = void 0 !== XMLHttpRequest.DONE ? XMLHttpRequest.DONE : 4;
                        if (t.readyState === p && 200 === t.status) {
                            let e = t.response;
                            if (202 !== e.code) return this.error.message = e.message, void(this.error.description = "An error occurred")
                        } else if (t.readyState === p && 200 !== t.status) return this.error.message = t.response.message, void(this.error.description = "An error occurred")
                    }.bind(this), t.onload = function(e) {}, t.onerror = function(e) {}, t.open("POST", this.cinetpay_url + "/seamless/device"), t.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), t.responseType = "json";
                    let p = {
                ...
                t.onprogress = function(e) {}, t.onreadystatechange = function(e) {
                    ...
                    if (t.readyState === p && 200 === t.status) {
                        let e = t.response;
                        if ("201" !== e.code) return this.error.message = e.message, void(this.error.description = e.description); {
                            let t = e.data;
                            this.checkout = t.payment_url, this.openCheckout()
                        }
                    } else if (t.readyState === p && 200 !== t.status) return this.error.message = t.response.message, void(this.error.description = t.response.description)
                }.bind(this), t.onload = function(e) {}, t.onerror = function(e) {}, t.open("POST", this.cinetpay_url + "/payment"), t.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), t.responseType = "json";
                let p = {
                    ...this.config,
                    ...this.payment_data
                };
    ...
    async initCheckout() {
        if (window.navigator.onLine) {
            ...
            if (this.loaded) e = !0, await this.initSocket();
                ...
                this.loaded = !0, t.onload = function() {
                    e || (e = !0, this.initSocket())
                }.bind(this), t.onreadystatechange = p, t.onerror = i, t.src = this.cdnjs, document.body.appendChild(t)
            }
        } else document.getElementById("cp_modal_first_parent").style.pointerEvents = "none", "WEB" === this.type && setTimeout((() => {
            document.getElementById("cp_modal_first_parent").style.display = "none", this.error.message = "ERROR_CONNECTION", this.error.description = "Please enable your internet connection and retry"
        }), 1e3)
    }
    openCheckout() {
        let e = document.createElement("iframe");
        e.id = "checkout", e.src = this.checkout, e.style.borderWidth = "0", e.style.width = "100%", e.style.height = "100%", this.createHtmlModalElement(), document.getElementById("cp-content").appendChild(e);
        let t = setInterval(function() {
            let e = this;
            document.getElementById("checkout").onload = function() {
                document.getElementById("cp-loader").style.display = "none", e.displayButton(), clearInterval(t)
            }.bind(e)
        }.bind(this), 10)
    }
    waitResponse(e) {
    ...
    onError(e) {
        let t = setInterval(function() {
            null != this.error.message && null != this.error.description && (e(this.error), clearInterval(t))
        }.bind(this), 300)
    }
    onClose(e) {
        let t = setInterval(function() {
            this.checkout_close && (e(), this.checkout_close = !1, clearInterval(t))
        }.bind(this), 300)
    }
    http() {
        let e = null;
        if (window.XMLHttpRequest) e = new XMLHttpRequest;
            ...
            for (let t = ["MSXML2.XmlHttp.6.0", "MSXML2.XmlHttp.5.0", "MSXML2.XmlHttp.4.0", "MSXML2.XmlHttp.3.0", "MSXML2.XmlHttp.2.0", "Microsoft.XmlHttp"], p = 0; p < t.length; p++) try {
                e = new ActiveXObject(t[p]);
                break
            } catch (e) {
                return this.error.message = e.name, void(this.error.description = e.message)
            }
