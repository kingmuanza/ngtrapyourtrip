...
(function(a) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(f) { return a(f, window, document) }) : "object" === typeof exports ? module.exports = function(f, d) {
        f || (f = window);
    ...
    a.extend(h.prototype, {
        ...
        _mouseUp: function(b) {
            ...
            this.c.editor ? (this.c.enable = !1, this.c.editor.edit(p, !1, a.extend({ submit: "changed" }, this.c.formOptions)).multiSet(g, k).one("preSubmitCancelled.rowReorder", function() {
                ...
                function() { c.draw(!1) }).one("submitSuccess.rowReorder", function() { v() }).one("submitComplete", function() {
                e.c.enable = !0;
                e.c.editor.off(".rowReorder")
            }).submit()) : v()
        },
...
if (!document.getElementById(cssId)) {
    ...
    this.Modal = function() {
        var e;
        this.closeButton = null, this.modal = null, this.overlay = null, this.transitionEnd = (e = document.createElement("div")).style.WebkitTransition ? "webkitTransitionEnd" : e.style.OTransition ? "oTransitionEnd" : "transitionend", arguments[0] && "object" == typeof arguments[0] && (this.options = function(e, a) { var o; for (o in a) a.hasOwnProperty(o) && (e[o] = a[o]); return e }({ autoOpen: !1, className: "fade-and-drop", closeButton: !0, content: "", height: 100, overlay: !0 }, arguments[0])), !0 === this.options.autoOpen && this.open()
    }, Modal.prototype.close = function() {
        var e = this;
        this.modal.className = this.modal.className.replace(" jh-open", ""), this.overlay.className = this.overlay.className.replace(" jh-open", ""), this.modal.addEventListener(this.transitionEnd, function() { e.modal.parentNode.removeChild(e.modal) }), this.overlay.addEventListener(this.transitionEnd, function() { e.overlay.parentNode && e.overlay.parentNode.removeChild(e.overlay) })
        ...
        (function() {
            ...
            function() { this.closeButton && this.closeButton.addEventListener("click", this.close.bind(this)), this.overlay && this.overlay.addEventListener("click", this.close.bind(this)) }.call(this), window.getComputedStyle(this.modal).height, this.modal.className = this.modal.className + (this.modal.offsetHeight > window.innerHeight ? " jh-open jh-anchored" : " jh-open"), this.overlay.className = this.overlay.className + " jh-open"
    }
}(), CinetPay = function() {
    var e = !1,
        a = 0,
        ...
        d = {},
        s = "",
        r = { signatureCreated: null, error: null, paymentSuccessfull: null, paymentPending: null, checkPaymentStatusStart: null, checkPaymentStatusStop: null, ajaxStart: null, ajaxStop: null },
        l = { cpm_currency: "CFA", cpm_page_action: "PAYMENT", cpm_payment_config: "SINGLE", cpm_amount: 0, cpm_trans_id: "", cpm_designation: "", cpm_custom: "", cpm_phone_prefixe: "", cel_phone_num: "" },
        m = { apikey: "", cpm_site_id: 0, cpm_version: "V2", cpm_language: "fr", cpm_trans_date: "", notify_url: "" },
        c = function(a, o) { "function" == typeof r[a] && ("error" === a && (e = !1), r[a](o)) },
        h = function(e, a) {
            var o = !1;
            switch (e.toLowerCase()) {
                ...
                case "version":
                    ...
                    break;
                case "language":
                    ["fr", "en", "ru", ""].indexOf(a) < 0 && (o = { code: "error_config", message: "language " + a + "is not available" })
            }
        ...
        p = function(e, a) {
            ...
            switch (e.toLowerCase()) {
                case "amount":
                    ...
                    break;
                case "currency":
                    ["CFA", "EUR", "XOF", "XAF", "CDF"].indexOf(a) < 0 && (o = { code: "error_payment_data", message: "Currency " + a + "is not available" });
                    break;
                case "page_action":
                    ["PAYMENT"].indexOf(a) < 0 && (o = { code: "error_payment_data", message: "Page Action is " + a + "is not available" })
            }
            return o ? (c("error", o), null) : a
        },
        f = function() {
            return !! function() {
                for (var a in m)
                    if (null === h(a, m[a])) return !1;
                return e = !0, !0
            }() && function() {
                for (var a in i)
                    if (null === p(a, i[a])) return !1;
                return e = !0, !0
            }()
        },
        u = function(e, a) { var o = {}; for (var t in e) o[t] = e[t]; for (var n in a) o[n] = a[n]; return o },
        g = function(e) {
            c("checkPaymentStatusStart");
            var a = { apikey: m.apikey, cpm_site_id: m.cpm_site_id, cpm_trans_id: d.cpm_trans_id };
            b.post({ url: n + "/?method=checkPayStatus", data: a, callbacks: { error: r.error, success: function(a) { void 0 === a.transaction ? (w(), r.error({})) : (c("checkPaymentStatusEnd", { code: a.transaction.cpm_result, message: a.transaction.cpm_trans_status }), void 0 === e || 1 == e && (a.transaction.lastTime = "ok"), void 0 !== a.transaction.cpm_amount ? "00" == a.transaction.cpm_result ? (w(), a.transaction.cpm_amount != d.cpm_amount ? r.error({ code: "payment_error", message: "Difference in charged amount, please contact CINETPAY." }) : r.paymentSuccessfull(a.transaction)) : "" === a.transaction.cpm_result || "623" === a.transaction.cpm_result ? void 0 === e ? r.paymentPending({ code: a.transaction.cpm_result, message: a.transaction.cpm_trans_status }) : 1 == e && ("" == a.transaction.cpm_error_message && (a.transaction.cpm_error_message = "User Cancel Payment"), r.paymentSuccessfull(a.transaction)) : r.error({ code: a.transaction.cpm_result, message: a.transaction.cpm_trans_status }) : (w(), r.error(o))) } } }), c("checkPaymentStatusStop")
        },
        w = function() { clearInterval(a) },
        y = function(e) {
            var a = document.createElement("div");
            a.innerHTML = "<section class='is-active modal--fade' id='cinetPayModal' tabindex='-1' role='dialog' aria-labelledby='modal-label' aria-hidden='true'><div class='modal-inner'>        <div class='modal-content'>            <iframe src='" + e + "' allowfullscreen='' frameborder='0' style=' overflow:hidden !important;'></iframe>        </div>    </div>    <a href='#' class='modal-close' id='cinetpayCloseModal' title='Fermer la boite de dialogue' data-close='Fermer'        data-dismiss='modal'>Fermer</a></section>", document.body.appendChild(a);
        ...
        b = {
            x: function() {
                ...
                for (var e, a = ["MSXML2.XmlHttp.6.0", "MSXML2.XmlHttp.5.0", "MSXML2.XmlHttp.4.0", "MSXML2.XmlHttp.3.0", "MSXML2.XmlHttp.2.0", "Microsoft.XmlHttp"], o = 0; o < a.length; o++) try { e = new ActiveXObject(a[o]); break } catch (e) {}
                return e
            },
            _send: function(e, a, o, t, n) { void 0 === n && (n = !0); var i = b.x(); "function" == typeof r.ajaxStart && r.ajaxStart(), i.open(o, e, n), i.onreadystatechange = function() { i.readyState == XMLHttpRequest.DONE && (200 == i.status ? void 0 !== a.success && a.success(JSON.parse(i.responseText)) : void 0 !== a.error && a.error({ code: "ajax_error", message: i.responseText }), "function" == typeof r.ajaxStop && r.ajaxStop()) }, "POST" == o && i.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), i.send(t) },
            post: function(e, a) {
                var o = [];
    ...
    return {
        on: function(e, a) { void 0 !== r[e] && "function" == typeof a && (r[e] = a) },
        setConfig: function(e) { for (var a in e) void 0 !== m[t + a] ? m[t + a] = h(a, e[a]) : "apikey" === a ? m.apikey = e.apikey : "notify_url" === a ? m.notify_url = e.notify_url : "cel_phone_num" === a && (m.cel_phone_num = e.cel_phone_num) },
        setSignatureData: function(e) { for (var a in i = JSON.parse(JSON.stringify(l)), e) void 0 !== i[t + a] ? i[t + a] = p(a, e[a]) : "cel_phone_num" === a && (i[a] = p(a, e[a])) },
        checkData: function() { return f() },
                    ...
                    success: function(o) {
                        void 0 !== o.status ? r.error(o.status) : (s = o, d.signature = o, r.signatureCreated(s), function() {
                            if (e) {
                                ...
                                var t = function(e) { var a = []; for (var o in e) e.hasOwnProperty(o) && a.push(encodeURIComponent(o) + "=" + encodeURIComponent(e[o])); return a.join("&") }(o);
                                return y("https://secure.cinetpay.com/?" + t), void(a = setInterval(function() { g() }, 6e3))
                            }
        ...
        stopPaymentStatusCheck: function() { w() }
    }
}()